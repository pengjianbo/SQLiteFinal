...
package cn.paojiao.sqlitefinal;
...
import cn.paojiao.sqlitefinal.sqlite.CursorUtils;
import cn.paojiao.sqlitefinal.sqlite.DbModelSelector;
import cn.paojiao.sqlitefinal.sqlite.Selector;
import cn.paojiao.sqlitefinal.sqlite.SqlInfo;
import cn.paojiao.sqlitefinal.sqlite.SqlInfoBuilder;
import cn.paojiao.sqlitefinal.sqlite.WhereBuilder;
import cn.paojiao.sqlitefinal.table.DbModel;
...
import cn.paojiao.sqlitefinal.utils.IOUtils;
import cn.paojiao.toolsfinal.Logger;
import java.io.File;
...
public class DbHelper {
    ...
    private DbHelper(DaoConfig config) {
        if (config == null) {
    ...
    private synchronized static DbHelper getInstance(DaoConfig daoConfig) {
        DbHelper dao = daoMap.get(daoConfig.getDbName());
        if (dao == null) {
            dao = new DbHelper(daoConfig);
    ...
    public static DbHelper create(Context context, String dbName) {
        DaoConfig config = new DaoConfig(context);
        config.setDbName(dbName);
        return getInstance(config);
    }

    public static DbHelper create(Context context, String dbDir, String dbName) {
        DaoConfig config = new DaoConfig(context);
    ...
    public static DbHelper create(Context context, String dbName, int dbVersion, DbUpgradeListener dbUpgradeListener) {
        DaoConfig config = new DaoConfig(context);
        config.setDbName(dbName);
    ...
    public static DbHelper create(Context context, String dbDir, String dbName, int dbVersion, DbUpgradeListener dbUpgradeListener) {
        DaoConfig config = new DaoConfig(context);
        config.setDbDir(dbDir);
        config.setDbName(dbName);
        config.setDbVersion(dbVersion);
    ...
    public static DbHelper create(DaoConfig daoConfig) {
        return getInstance(daoConfig);
    }

    public DbHelper configDebug(boolean debug) {
        this.debug = debug;
        return this;
    }

    public DbHelper configAllowTransaction(boolean allowTransaction) {

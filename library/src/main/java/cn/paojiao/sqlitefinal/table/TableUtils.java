...
import cn.paojiao.sqlitefinal.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, cn.paojiao.sqlitefinal.table.Id> entityIdMap = new ConcurrentHashMap<String, cn.paojiao.sqlitefinal.table.Id>();

    /* package */
    static synchronized cn.paojiao.sqlitefinal.table.Id getId(Class<?> entityType) {
        ...
        cn.paojiao.sqlitefinal.table.Id id = new cn.paojiao.sqlitefinal.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        cn.paojiao.sqlitefinal.table.Id id = getId(entityType);

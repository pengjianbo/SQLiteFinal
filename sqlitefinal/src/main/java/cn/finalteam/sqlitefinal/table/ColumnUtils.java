...
import cn.finalteam.sqlitefinal.annotation.Check;
...
import cn.finalteam.sqlitefinal.annotation.NotNull;
import cn.finalteam.sqlitefinal.annotation.Transient;
import cn.finalteam.sqlitefinal.annotation.Unique;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(cn.finalteam.sqlitefinal.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(cn.finalteam.sqlitefinal.table.Finder finderColumn) {

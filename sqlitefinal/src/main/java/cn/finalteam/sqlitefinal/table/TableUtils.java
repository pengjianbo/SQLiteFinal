...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, cn.finalteam.sqlitefinal.table.Id> entityIdMap = new ConcurrentHashMap<String, cn.finalteam.sqlitefinal.table.Id>();

    /* package */
    static synchronized cn.finalteam.sqlitefinal.table.Id getId(Class<?> entityType) {
        ...
        cn.finalteam.sqlitefinal.table.Id id = new cn.finalteam.sqlitefinal.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        cn.finalteam.sqlitefinal.table.Id id = getId(entityType);
